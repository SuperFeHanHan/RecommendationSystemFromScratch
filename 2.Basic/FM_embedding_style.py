...
class FM( nn.Module ):
    ...
    def FMcross(self, feature_embs):
        # feature_embs:[ batch_size, n_features, dim ] = [N,n,k]
        # [batch_size, dim]
    ...
    def forward(self, u, i, user_df, item_df):
        #得到用户与物品组合起来后的特征索引
        all_feature_index = self.__getAllFeatures( u, i, user_df, item_df ) # [N,L]
        #取出特征向量
        all_feature_embs = self.features( all_feature_index ) # [N,L,EMB=128]
        #经过FM层得到输出
